...
#import "BWRecommendValidator.h"

@implementation BWRecommendValidator
...
- (BOOL)validateInput:(UITextField *)input {
    ...
    if (input.text.length <= 0) {
        ...
        BOOL isMatch = [input.text isValidWithMinLenth:1 maxLenth:20 containChinese:NO firstCannotBeDigtal:NO];
        if (isMatch == NO) {
...
//        self.errorMessage = @"输入的推荐码不能超过7个字符哦!";
